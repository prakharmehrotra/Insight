var vishna = (function() {
    ...
    var urls = {      //API urls
        //news  : "http://www.bbc.co.uk/tv/programmes/genres/drama/scifiandfantasy/schedules/upcoming.json",
        news  : "http://hndroidapi.appspot.com/news/format/json/page/?appid=vishna&callback=?",
        best   : "http://hndroidapi.appspot.com/ask/format/json/page/?appid=vishna&callback=?",
        ask: "http://hndroidapi.appspot.com/newest/format/json/page/?appid=vishna&callback=?",
        newest  : "http://hndroidapi.appspot.com/best/format/json/page/?appid=vishna&callback=?"
    },
        thread = /^(item[?]id[=][0-9]+)/,               //regexp for HN thread posts
        w = Math.max( $(window).width() * 0.75, 760 ),  //width
        h = Math.max( $(window).height() * 0.75, 600 ), //height
        m = 20,                                         //margin
        ...
        gravity  = 0.06,//gravity constants
        damper   = 0.2,
        friction = 0.85,
